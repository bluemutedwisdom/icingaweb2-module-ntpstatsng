...
IMPORTANT: **The module does not have any functionality yet!** First the link:doc/01-About.md[documentation] (for link:https://github.com/wols/icingaweb2-module-ntpstatsng/milestones[milestones]) will be created.
